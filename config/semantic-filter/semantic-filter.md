Only numbered sentences are eligible. Return spans as `start` and `end` refs in the `1.2` form.
...
{
    "results": [
        { "start": "1.2", "end": "1.3", "confidence": "clear", "reasonToKeep": "States the policy position the intent names." },
        { "start": "2.7", "end": "2.7", "confidence": "borderline", "reasonToKeep": "Implies the sentiment via described behavior; the disqualifier for generic uncertainty may apply." }
    ]
}
```
